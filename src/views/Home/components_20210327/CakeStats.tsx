...
const CakeStats = () => {
  ...
  let bbqPerBlock = 0
  if (farms && farms[0] && farms[0].bbqPerBlock) {
    bbqPerBlock = new BigNumber(farms[0].bbqPerBlock).div(new BigNumber(10).pow(18)).toNumber()
  }
  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">{TranslateString(540, 'New BBQ/block')}</Text>
