  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const cakeRewardPerBlock = new BigNumber(farm.bbqPerBlock || 1)
    ...
    <>
      <Header>
        <Heading as="h1" size="xxl" color="secondary" mb="24px">
          {tokenMode
            ? TranslateString(10002, 'Stake tokens to earn BBQ')
            : TranslateString(320, 'Stake LP tokens to earn BBQ')}
        </Heading>
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback BBQ')}
        </Heading>
      ...
      <Page>
        ...
        {renderContent()}
        <img src="/images/barbecue-cutlery-3.png" alt="illustration" className="img-footer" />
      </Page>
    </>
  )
}
